...
## Server Architecture
Server architecture evolved over time from local desktop to central server. Added dev server SFTP, backup, intern server. Considered dev server the disaster preparedness resource.
